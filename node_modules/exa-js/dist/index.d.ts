...
type DeepSearchType = "deep-lite" | "deep" | "deep-reasoning";
/**
 * Deep search output schema mode for plain text responses.
 */
type DeepTextOutputSchema = {
    type: "text";
    /**
 ...
 */
type DeepOutputSchema = DeepTextOutputSchema | DeepObjectOutputSchema;
/**
...
type DeepSearchOutputGroundingCitation = {
    url: string;
    title: string;
};
type DeepSearchOutputGroundingConfidence = "low" | "medium" | "high";
type DeepSearchOutputGrounding = {
    field: string;
...
type SearchStreamChunk = AnswerStreamChunk;
/**
...
declare class Exa {
     ...
     */
    streamSearch(query: string, options?: RegularSearchOptions & {
